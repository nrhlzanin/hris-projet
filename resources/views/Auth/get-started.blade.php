        ...
        <div class="w-full md:w-1/2 p-6 md:p-10 flex items-start justify-center overflow-auto">
            ...
            <p class="text-center text-sm mt-4">Already have an account? <a href="{{ route('sign.in') }}" class="text-blue-600 underline">Sign in here</a></p>
                <form class="space-y-5">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 rounded">SIGN UP</button>
                    <button type="button"
                        class="w-full bg-gray-400 hover:bg-blue-500 text-white font-bold py-2 rounded">Sign up with Google</button>

                    <p class="text-center text-sm mt-4">Already have an account? <a href="{{ route('sign.in') }}"
                            class="text-blue-600 underline">Sign in here</a></p>
                </form>
            </div>
        </div>
    </div>
