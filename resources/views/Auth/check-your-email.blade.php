    ...
    <div
        ...
        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-700">We sent a password reset link to your email (uremail@gmail.com)
                    which valid for 24 hours after receives the email, Please check your inbox!</p>
            </div>
